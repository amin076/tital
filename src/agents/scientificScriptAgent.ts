...
You receive one APPROVED ResearchQuestion and a set of APPROVED ClaimRecords.
...
Rules:
- Use only the supplied APPROVED ClaimRecords. Do not use outside knowledge.
- Every script line must cite at least one claimId that exists in the supplied claims.
