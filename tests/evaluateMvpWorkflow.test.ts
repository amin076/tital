...
function approvedState(): MvpWorkflowState {
  return {
    ...
    scenes: [{ id: 'SC-1', researchQuestionId: 'RQ-1', scriptLineIds: ['SL-1'], title: 'Hidden Ocean', purpose: 'Explain the evidence', description: 'Move from observed surface to scientific reconstruction.', uncertaintyDisclosure: 'Reconstruction is evidence-based, not a direct observation.', status: 'APPROVED' }],
